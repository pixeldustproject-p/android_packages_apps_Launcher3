...
import com.pixeldust.launcher.qsb.configs.QsbConfiguration;
import com.pixeldust.launcher.qsb.search.DefaultSearchView;
import com.pixeldust.launcher.search.SearchThread;
...
public class AllAppsQsbView extends BaseQsbView implements SearchUiManager, OnChangeListener {
    ...
    protected void setSearchType() {
        boolean useDefaultSearch = !Bits.hasPackageInstalled(Launcher.getLauncher(mContext), PixelDustLauncherCallbacks.SEARCH_PACKAGE);
