...
public class LongClickReceiver extends BroadcastReceiver {
    ...
    public static WeakReference<PixelDustLauncher> mWeakReference = new WeakReference(null);

    public static void getWeakReference(PixelDustLauncher launcher) {
        mWeakReference = new WeakReference(launcher);
    }

    @Override
    public void onReceive(Context context, Intent intent) {
        PixelDustLauncher launcher = (PixelDustLauncher) mWeakReference.get();
        if (launcher != null) {
