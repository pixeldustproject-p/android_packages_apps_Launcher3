 ...
 */
package com.pixeldust.launcher.quickspace;
...
import com.pixeldust.launcher.views.DateTextView;
import com.pixeldust.launcher.PixelDustLauncher.PixelDustLauncherCallbacks;
import com.pixeldust.launcher.quickspace.QuickspaceController.OnDataListener;
import com.pixeldust.launcher.quickspace.receivers.QuickSpaceActionReceiver;
...
public class QuickSpaceView extends FrameLayout implements AnimatorUpdateListener, Runnable, OnDataListener {
    ...
    public final void bindClockAndSeparator(boolean forced) {
        boolean hasGoogleCalendar = PixeldustUtils.isPackageInstalled(Launcher.getLauncher(mContext), "com.google.android.calendar");
    ...
    public final void bindWeather(View container, TextView title, ImageView icon) {
        boolean hasGoogleApp = Utilities.hasFeedIntegration(mContext);
        mWeatherAvailable = mController.isWeatherAvailable();
