...
// Event identifiers start
 ...
 // Event identifiers end
    ...
    private void deviceIntroEvent() {
        ...
        mIsQuickEvent = true;
        mEventIntro = true;
        mEventTitle = mContext.getResources().getString(R.string.quick_event_intro_welcome);
        mEventTitleSub = mContext.getResources().getString(R.string.quick_event_intro_learn);
