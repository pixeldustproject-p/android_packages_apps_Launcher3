 ...
 */
package com.pixeldust.launcher.quickspace.receivers;
...
public class QuickSpaceActionReceiver {
    ...
    private void openGoogleCalendar(View view) {
        ...
        try {
            ...
            LauncherAppsCompat.getInstance(mContext).showAppDetailsForProfile(new ComponentName(PixelDustLauncherCallbacks.SEARCH_PACKAGE, ""), Process.myUserHandle());
        }
    }
    ...
    private void openGoogleWeather(View view) {
        ...
        intent.setComponent(new ComponentName(PixelDustLauncherCallbacks.SEARCH_PACKAGE, "com.google.android.apps.gsa.velour.DynamicActivityTrampoline"));
        try {
            Launcher.getLauncher(mContext).startActivitySafely(view, intent, null);
        } catch (ActivityNotFoundException ex) {
            LauncherAppsCompat.getInstance(mContext).showAppDetailsForProfile(new ComponentName(PixelDustLauncherCallbacks.SEARCH_PACKAGE, 
